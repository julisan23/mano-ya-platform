                                        ...
                                        <div key={pro.id} className="bg-white/5 border border-white/10 rounded-xl p-4 flex justify-between items-center hover:bg-white/10 transition-colors">
                                            <div>
                                                <h4 className="font-bold text-lg text-white flex items-center gap-2">
                                                    {pro.name}
                                                    {pro.status === 'VERIFIED' && (
                                                        <Shield className="w-4 h-4 text-action-400" title="Verificado por MANO YA" />
                                                    )}
                                                </h4>
                                                <div className="flex items-center gap-4 text-sm text-brand-300 mt-1">
                                                    ...
                                                    <span className="flex items-center gap-1 text-yellow-400"><Star className="w-3 h-3 fill-yellow-400" /> {pro.rating || 'N/A'}</span>
                                                </div>
                                            </div>
